...
function runExtendScript(scriptPath, args = {}) {
    try {
...
function readResultsFromTempFile() {
    try {
        // Use the exact paths shown in the After Effects alert
        const tempFilePath = 'C:/Users/Dakkshin/AppData/Local/Temp/ae_mcp_result.json';
        console.error(`Looking for results file at: ${tempFilePath}`);
...
function writeCommandFile(command, args = {}) {
    try {
        // Use the exact path shown in the After Effects alert
        const commandFile = 'C:/Users/Dakkshin/AppData/Local/Temp/ae_command.json';
...
server.tool("run-script", "Run a read-only script in After Effects", {
...
server.prompt("analyze-composition", {
